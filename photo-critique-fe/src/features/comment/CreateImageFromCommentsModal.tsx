    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
      ...
      <div className="w-full h-full max-w-7xl max-h-[95vh] bg-white rounded-3xl overflow-hidden flex flex-col m-4">
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="w-46 border-r border-gray-200 flex flex-col bg-white relative">
                ...
                >
                  ...
                  {index === selectedImageIndex && (
                    <div className="absolute top-2 left-2 p-1 rounded-full bg-[#15B8A6]">
                      <CheckIcon className="w-4 h-4 text-white stroke-[3.5]" />
                    </div>
                  )}
          ...
          <div className="w-106 border-l border-gray-200 flex flex-col bg-white relative">
            <div className="p-4 border-b border-gray-200">

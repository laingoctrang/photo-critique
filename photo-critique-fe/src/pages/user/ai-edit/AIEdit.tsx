...
import { generateService, imageGenerationHistoryService, type ImageGenerationHistoryResponse } from "../../../services";
            ...
            <div className="flex-1 flex flex-col overflow-y-auto">
              ...
              <div className="flex-1 min-h-0 relative">
                ...
                <FileUpload
                  ...
                  className="h-[calc(100vh-250px)] w-full rounded-3xl flex flex-col justify-center items-center"

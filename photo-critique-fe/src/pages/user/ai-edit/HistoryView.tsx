...
import { ArrowDownIcon, ArrowPathIcon, PencilSquareIcon, TrashIcon } from "@heroicons/react/24/outline";
    ...
    <>
      <div className="h-full flex flex-col overflow-hidden">
        <div className="flex-1 overflow-y-auto">
          <div className="w-full space-y-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {history.map((item) => (
              <div
                key={item.id}
                ...
                <div className="p-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      leftIcon={TrashIcon}
                      className="bg-gray-200 hover:bg-red-100 hover:text-red-700 p-3 rounded-xl"
                    >
                    </Button>
                  </div>
                </div>
